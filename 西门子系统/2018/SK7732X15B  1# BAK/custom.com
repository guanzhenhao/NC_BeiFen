...
;*************************************************************************************************************************************	
	...
	DEF VAR101=(I/*0=$85185,*1=$85186//,,,/WR2/""/"/NC/_N_NC_GD2_ACX/INI[96]"//320,60,40/8,4);蜗杆模数选择(轴向/法向)
	DEF VAR102=(R4///$85187,$85187,$85042,/WR1/""/"/NC/_N_NC_GD2_ACX/INI[97]"/200,260,202/250,260,70/);	螺旋升角
	...
	DEF VAR107=(R6/0,50//$85193,$85193,$85043,/WR2/"panel_1_6_chs.png"/"/NC/_N_NC_GD2_ACX/INI[121]"/360,240,205/457,240,68/);右齿面模数
	DEF VAR108=(R6///$85195,$85195,$85043,/WR1/"panel_1_6_chs.png"/"/NC/_N_NC_GD2_ACX/INI[122]"/360,260,205/457,260,68/8,129);右齿面导程
...
;*************************************************************************************************************************************	
	...
	DEF VAR10=(R/-500,500//$85165,$85165,,/WR2/"panel_1_9_chs.png"/"/NC/_N_NC_GD2_ACX/INI[11]"/360,160,202/457,160,68/);对刀起始位置
	DEF GRIND_SAFE=(R/-500,500//$85172,$85172,,/WR2/"panel_1_23_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[17]"/360,180,202/457,180,68/);磨削安全位置
	DEF X_QUIT=(R/-500,500//$85106,$85106,,/WR2/"panel_1_10_chs.png"/"/NC/_N_NC_GD2_ACX/INI[24]"/360,200,202/457,200,68/);退刀位置
	DEF PITCH_COM=(R/-500,500//$85105,$85105,$85043,/WR2/"panel_1_11_chs.png"/"/NC/_N_NC_GD2_ACX/INI[25]"/360,220,205/457,220,68/);全长导程补偿
...
;*************************************************************************************************************************************			
	...
	IF VAR104.VAL==0
		...
		VAR108.VAL=(PI*VAR107.VAL*VAR6.VAL)/(cos(SRAD(-VAR102)))
		ENDIF
		IF VAR103.VAL==0
		   VAR102.WR=1
		ELSE
