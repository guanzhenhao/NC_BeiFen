...
;;;;;;;;;;;;;;;;;;;MASK0:出厂信息:panel_0:;;;;;;;;;;;;;;;;;;;;;;;;;
//M(Mask0/$85024/"panel_0_1_eng.png"/)
...
//M(Mask1/$85020/"panel_1_1_eng.png"/)
	...
	DEF VAR11=(I/*0=$85146,1=$85147,2=$85148//$85145,,,/WR2/"panel_1_3_eng.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[20]"/0,0,0/270,10,70/);选择对刀位置
	DEF jixieshou=(I/*0=$85041,1=$85040//$85111,$85111,,/WR2/"panel_1_3_eng.png"/"/NC/_N_NC_GD2_ACX/INI[86]"/270,30,80/320,30,20/);是否使用机械手
	DEF PIECE_VOLUME=(I/*0=$85166,1=$85167//$85170,,,/WR2/"panel_1_17_eng.png"/"/NC/_N_NC_GD2_ACX/INI[27]"/360,10,70/460,10,80/);单件/批量磨削方式选择
	DEF SCREW_R=(I/*0=$85124,1=$85125//$85103,$85103,,/WR2/"panel_1_4_eng.png"/"/NC/_N_NC_GD2_ACX/INI[1]"/360,40,90/460,40,60/);螺纹旋向
	DEF VAR6=(I/0,50//$85102,$85102,$85051,/WR2/"panel_1_5_eng.png"/"/NC/_N_NC_GD2_ACX/WORK[1]"/360,60,182/460,60,40/);工件头数

	DEF VAR7=(R3/0,50//$85104,$85104,$85043,/WR2/"panel_1_6_eng.png"/"/NC/_N_NC_GD2_ACX/INI[5]"/360,80,202/460,80,60/);工件螺距输入
	DEF CHIJU=(R////WR4//"/NC/_N_NC_GD2_ACX/INI[5]"/0,0,0/0,0,0);蜗杆齿距引用
	DEF YINGZHI=(R6/0,50//$85173,$85173,,/WR4/"panel_1_28_eng.png"/"/NC/_N_NC_GD2_ACX/INI[117]"/360,80,202/460,80,70/);蜗杆径节(英制)
	DEF MOSHU=(R6/0,50//$85173,$85173,,/WR4/"panel_1_28_eng.png"/"/NC/_N_NC_GD2_ACX/INI[77]"/360,80,202/460,80,70/);蜗杆模数
	DEF M_OR_L=(I/*0=$85179,1=$85178,2=$85177//,,,/WR4/"panel_1_28_eng.png"/"/NC/_N_NC_GD2_ACX/INI[87]"/0,0,0/360,10,80/);选择输入模数0输入螺距1输入径节2

	DEF VAR8=(R3/-2000,2000//$85108,$85108,,/WR2/"panel_1_7_eng.png"/"/NC/_N_NC_GD2_ACX/INI[2]"/360,100,202/460,100,60/);工件左端
	DEF VAR9=(R3/-2000,2000//$85109,$85109,,/WR2/"panel_1_8_eng.png"/"/NC/_N_NC_GD2_ACX/INI[3]"/360,120,202/460,120,60/);工件右端
	DEF VAR10=(R/-500,500//$85165,$85165,,/WR2/"panel_1_9_eng.png"/"/NC/_N_NC_GD2_ACX/INI[11]"/360,150,202/460,150,60/);对刀起始位置
	DEF GRIND_SAFE=(R/-500,500//$85172,$85172,,/WR2/"panel_1_23_eng.png"/"/NC/_N_NC_GD2_ACX/PROCESS[17]"/360,170,202/460,170,60/);磨削安全位置
	DEF X_QUIT=(R/-500,500//$85106,$85106,,/WR2/"panel_1_10_eng.png"/"/NC/_N_NC_GD2_ACX/INI[24]"/360,190,202/460,190,60/);退刀位置
	DEF INI_Z=(R/-677,31//$85113,$85113,$85043,/WR2/""/"/NC/_N_NC_GD2_ACX/INI[118]"/360,210,202/460,210,60/);机械手装夹工件时Z 轴位置
	DEF PITCH_COM=(R/-500,500//$85105,$85105,$85043,/WR2/"panel_1_11_eng.png"/"/NC/_N_NC_GD2_ACX/INI[25]"/360,230,202/460,230,60/);全长导程补偿
	DEF num=(I/0,500//$8510,$85110,,/WR2//"$R[51]"/360,250,202/460,250,60/);料盘工件总数
	;DEF VAR20=(I/*0=$85014,1=$85013//$85159,$85159,,/WR2/"panel_1_12_eng.png"/"/NC/_N_NC_GD2_ACX/INI[12]"/360,270,80/405,270,30/);是否有锥度
	;DEF VAR21=(I/-10,10//$85160,,,$85052/WR2/"panel_1_13_eng.png"/"/NC/_N_NC_GD2_ACX/INI[13]"/0,0,0/460,270,85/);锥度分子,默认内螺纹大头往小头磨,外螺纹小头往大头磨
	;DEF VAR22=(I/0,800//$85161,,,/WR2/"panel_1_14_eng.png"/"/NC/_N_NC_GD2_ACX/INI[14]"/0,0,0/505,270,40/);锥度分母

	DEF VAR23=(I/*0=$85014,1=$85013//$85164,$85164,,/WR2/"panel_1_18_eng.png"/"/NC/_N_NC_GD2_ACX/INI[39]"/340,290,150/420,290,30/);螺旋升角自动计算
	DEF VAR24=(I/0,45//$85055,,,$85042/WR2/"panel_1_19_eng.png"/"/NC/_N_NC_GD2_ACX/INI[18]"/0,290,0/460,290,75/);度
	DEF VAR25=(I/0,59//$85056,,,$85053/WR2/"panel_1_20_eng.png"/"/NC/_N_NC_GD2_ACX/INI[19]"/0,290,0/495,290,70/);分
	DEF VAR26=(I/0,59//$85057,,,$85054/WR2/"panel_1_21_eng.png"/"/NC/_N_NC_GD2_ACX/INI[20]"/0,290,0/525,290,70/);秒
	DEF WORK_MID_DIA=(R/0,400//$85107,$85107,$85043,/WR4/"panel_1_22_eng.png"/"/NC/_N_NC_GD2_ACX/INI[40]"/340,310,222/460,310,60/);分度圆直径
	...
	DEF WHELL_POS_INI=(R///$85169,$85169,,/WR1/"panel_1_24_eng.png"/"/NC/_N_NC_GD2_ACX/PROCESS[14]"/10,350,210/120,350,60/);初始磨削接触位(对刀完成后磨削接触位)

	DEF DIAMETER_ADJ=(R///$85174,$85174,$85043,/WR2/"panel_1_26_eng.png"/"/NC/_N_NC_GD2_ACX/GRIND[5]"/340,330,222/460,330,60/);单次中径调整值
	DEF PianDaoTiaoZheng=(R/-100,100//$85175,$85175,$85043,/WR2/"panel_1_27_eng.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[43]"/340,350,222/460,350,60/);Z轴偏刀调整
...
//M(Mask2/$85021/"panel_2_0_eng.png"/)
...
//M(Mask29/$85021/"panel_2_0_eng.png"/)
...
//M(Mask20/$85021/"panel_20_0_eng.png"/)
...
//M(Mask30/$85021/"panel_20_0_eng.png"/)
...
//M(Mask3/$85022/"panel_3_4_eng.png"/)
	...
	DEF VAR2=(I/*0=$85380,1=$85381,2=$85382/1/$85388,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[4]"/0,0,0/440,10,80/);修整轮类型:双滚轮,修整轮类型,生成文件用
	
	DEF VAR5=(I/0,1000//$85340,$85340,,/WR2/"panel_3_5_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[26]"/330,60,110/440,60,60/);粗修次数
	DEF VAR6=(R/0,0.5//$85308,$85308,,$85043/WR2/"panel_3_5_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[28]"/330,80,110/440,80,110/);粗修量
	DEF VAR7=(R/0,1000//$85306,$85306,,$85045/WR2/"panel_3_5_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[30]"/330,100,110/440,100,110/);粗修速度

	DEF VAR8=(I/0,1000//$85341,$85341,,/WR2/"panel_3_6_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[27]"/330,130,110/440,130,60/);精修次数
	DEF VAR9=(R/0,0.5//$85309,$85309,,$85043/WR2/"panel_3_6_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[29]"/330,150,110/440,150,110/);精修量
	DEF VAR10=(R/0,1000//$85307,$85307,,$85045/WR2/"panel_3_6_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[31]"/330,170,110/440,170,110/);精修速度

	DEF VAR12=(R/0,200//$85316,$85316,,$85043/WR2/"panel_3_9_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[23]"/330,200,110/440,200,110/);砂轮宽度
	DEF VAR13=(R/0,1000//$85319,$85319,,$85043/WR2/"panel_3_7_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[24]"/330,220,110/440,220,110/);新砂轮直径
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[25]"/330,240,110/440,240,110/);砂轮当前直径
	DEF VAR15=(R/0,80//$85317,$85317,,$85046/WR2/"panel_3_8_eng.png"/"/NC/_N_NC_GD2_ACX/WHEEL_LINESPEED_DRESS[2]"/330,260,110/440,260,110/);砂轮线速度
	DEF VAR16=(I///$85221,$85221,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[37]"/330,280,110/440,280,110/);修整时砂轮转速

	DEF WHEEL_W_MIN=(R/0,1000//$85303,$85303,,$85043/WR4/"panel_3_10_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[36]"/330,310,130/440,310,110/);砂轮最小直径

	DEF VAR4=(I/*0=$85327,1=$85328//$85350,,,/WR2/"panel_3_4_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[6]"/0,0,0/440,30,80/);砂轮状态
	DEF CHENGXING=(I/*0=$85301,1=$85302//$85300,,,/WR4/"panel_3_14_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[114]"/0,0,0/510,30,40/);新砂轮是否是成型砂轮(0否1是)
...
//M(Mask21/$85026/"panel_21_2_eng.png"/)
	...
	DEF VAR0=(R/-100,100//$85529,$85529,,$85043/WR2/"panel_blank_eng.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[42]"/320,10,150/440,10,110/);对刀结果调整

	DEF VAR1=(R/-2000,2000//$85528,$85528,,$85043/WR4/"panel_21_1_eng.png"/"/NC/_N_NC_GD2_ACX/INI[43]"/320,40,150/440,40,110/);砂轮中心与接近开关重合Z坐标，外螺纹自动对刀用
	DEF VAR16=(R/-2000,2000//$85535,$85535,,$85043/WR4/"panel_21_1_eng.png"/"/NC/_N_NC_GD2_ACX/INI[43]"/320,40,150/440,40,110/);砂轮中心与测头中心重合Z坐标，外螺纹自动对刀用

	DEF VAR17=(R/-2000,2000//$85536,$85536,,$85043/WR4/"panel_21_1_eng.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[51]"/320,70,150/440,70,110/);外螺纹自动对刀测量头中心(左)到接近开关(右)的水平距离

	DEF VAR2=(R/-2000,2000//$85503,$85503,,$85043/WR4/"panel_21_4_eng.png"/"/NC/_N_NC_GD2_ACX/INI[49]"/330,40,110/440,40,110/);内螺纹自动对刀测头Z轴方向起始位置

	DEF VAR3=(R/-500,500//$85505,$85505,,$85043/WR4/"panel_21_6_eng.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[24]"/330,70,110/440,70,110/);内螺纹测头球中心/接近开关探测面与磨杆距离(X向)
	DEF VAR4=(R/-500,500//$85527,$85527,,$85043/WR4/"panel_21_7_eng.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[11]"/330,90,110/440,90,110/);内螺纹测头/开关与砂轮距离(Z向)

	DEF VAR7=(R/-2000,2000//$85513,$85513,,$85043/WR4/"panel_21_10_eng.png"/"/NC/_N_NC_GD2_ACX/INI[53]"/330,120,110/440,120,110/);内螺纹自动对刀开关测量方式下，开关进入工件开始测量Z起始位置
	DEF VAR8=(R/0,359//$85504,$85504,,$85042/WR4/"panel_21_5_eng.png"/"/NC/_N_NC_GD2_ACX/INI[50]"/330,120,110/440,120,110/);内螺纹测头自动对刀工件C方向合适角度

	DEF VAR5=(R/0,500//$85512,$85512,,$85043/WR4/"panel_21_9_eng.png"/"/NC/_N_NC_GD2_ACX/INI[52]"/330,150,110/440,150,110/);内螺纹工件小径(开关)
	DEF VAR6=(R/0,500//$85506,$85506,,$85043/WR4/"panel_21_8_eng.png"/"/NC/_N_NC_GD2_ACX/INI[35]"/330,150,110/440,150,110/);内螺纹工件大径(测量头)

	DEF VAR9=(R/0,10//$85507,$85507,,$85043/WR4/"panel_21_11_eng.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[10]"/330,180,110/440,180,110/);测头半径

	DEF VAR10=(R/0,500//$85508,$85508,,$85043/WR4/"panel_21_12_eng.png"/"/NC/_N_NC_GD2_ACX/INI[36]"/330,210,110/440,210,110/);工件端面到反相器孔距离

	DEF VAR15=(R/0,100//$85531,$85531,,$85043/WR2/"panel_21_23_eng.png"/"/NC/_N_NC_GD2_ACX/PROCESS[55]"/330,240,110/440,240,110/);缺口的深度

	DEF VAR11=(I/*0=$85510,1=$85511//$85509,,,/WR4/"panel_21_3_eng.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[23]"/0,0,0/440,270,60);(0=圆形孔,1=腰型孔)
	...
	;DEF VAR20=(R///$85517,$85517,,$85043/WR4/"panel_21_13_eng.png"/"/NC/_N_NC_GD2_ACX/PROCESS[54]"/10,260,130/140,260,110/);磨削中心自动对刀测头顶部在工件中心时X轴坐标
	;DEF VAR21=(R///$85530,$85530,,$85043/WR4/"panel_21_14_eng.png"/"/NC/_N_NC_GD2_ACX/PROCESS[53]"/10,280,130/140,280,110/);磨削中心外圆磨砂轮面在工件中心时U轴坐标
	;DEF VAR22=(R///$85532,$85532,,$85043/WR4/"panel_21_15_eng.png"/"/NC/_N_NC_GD2_ACX/PROCESS[51]"/10,300,130/140,300,110/);磨削中心端面磨砂轮侧面与测头中心间距
	;DEF VAR23=(R/0,100//$85801,$85801,,$85043/WR4/"panel_21_16_eng.png"/"/NC/_N_NC_GD2_ACX/INI[44]"/10,320,130/140,320,110/);工件耳高
	;DEF VAR24=(R/0,500//$85706,$85706,,$85043/WR4/"panel_21_17_eng.png"/"/NC/_N_NC_GD2_ACX/INI[31]"/10,340,130/140,340,110/);工件外圆长度
...
//M(Mask5/$85381//)
	...
	DEF VAR3=(R/0,300//$85902,$85614,,$85043/WR2//"$R[10]"/330,40,110/440,40,110/);双滚轮间距
...
//M(Mask10/$85022/"panel_3_4_eng.png"/)
	...
	DEF VAR4=(I/*0=$85327,1=$85328//$85350,,,/WR1/"panel_3_4_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[6]"/0,0,0/440,30,80/);砂轮状态
	DEF CHENGXING=(I/*0=$85301,1=$85302//$85300,,,/WR4/"panel_3_14_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[114]"/0,0,0/510,30,40/);新砂轮是否是成型砂轮(0否1是)

	DEF VAR5=(I/0,1000//$85340,$85340,,/WR1/"panel_3_5_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[26]"/330,60,110/440,60,60/);粗修次数
	DEF VAR6=(R/0,0.5//$85308,$85308,,$85043/WR1/"panel_3_5_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[28]"/330,80,110/440,80,110/);粗修量
	DEF VAR7=(R/0,1000//$85306,$85306,,$85045/WR1/"panel_3_5_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[30]"/330,100,110/440,100,110/);粗修速度

	DEF VAR8=(I/0,1000//$85341,$85341,,/WR1/"panel_3_6_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[27]"/330,130,110/440,130,60/);精修次数
	DEF VAR9=(R/0,0.5//$85309,$85309,,$85043/WR1/"panel_3_6_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[29]"/330,150,110/440,150,110/);精修量
	DEF VAR10=(R/0,1000//$85307,$85307,,$85045/WR1/"panel_3_6_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[31]"/330,170,110/440,170,110/);精修速度

	DEF VAR12=(R/0,200//$85316,$85316,,$85043/WR4/"panel_3_9_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[23]"/330,200,110/440,200,110/);砂轮宽度
	DEF VAR13=(R/0,1000//$85319,$85319,,$85043/WR1/"panel_3_7_eng.png"/"/NC/_N_NC_GD2_ACX/DRESSER[24]"/330,220,110/440,220,110/);新砂轮直径
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[25]"/330,240,110/440,240,110/);砂轮当前直径
	DEF VAR15=(R/0,80//$85317,$85317,,$85046/WR1/"panel_3_8_eng.png"/"/NC/_N_NC_GD2_ACX/WHEEL_LINESPEED_DRESS[2]"/330,260,110/440,260,110/);砂轮线速度
	DEF VAR16=(I///$85221,$85221,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[37]"/330,280,110/440,280,110/);修整时砂轮转速
...
;;;;;;;;;;;;;;;;;;;MASK50::;;;;;;;;;;;;;;;;;;;;;;
//M(Mask50/$85990/)
DEF work90=(I///,$85998,,/wr0,al2///0,110,510)
DEF VAR901=(B/*0=$85014,1=$85013//$85981,$85981,,/WR1//"Q4.4"/30,220,100/30,250,30/),
DEF VAR902=(B/*0=$85014,1=$85013//$85982,$85982,,/WR1//"Q4.6"/110,220,100/110,250,30/),
DEF VAR903=(B/*0=$85014,1=$85013//$85983,$85983,,/WR1//"Q4.5"/190,220,100/190,250,30/),
DEF VAR904=(B/*0=$85014,1=$85013//$85984,$85984,,/WR1//"Q5.1"/270,220,100/270,250,30/),
DEF VAR905=(B/*0=$85014,1=$85013//$85985,$85985,,/WR1//"Q5.6"/350,220,100/350,250,30/),
DEF VAR906=(B/*0=$85014,1=$85013//$85986,$85986,,/WR1//"Q5.7"/430,220,100/430,250,30/),
                                                     
DEF VAR907=(B/*0=$85014,1=$85013//$85987,$85987,,/WR1//"I0.0"/30,150,100/30,180,30/),
DEF VAR908=(B/*0=$85014,1=$85013//$85988,$85988,,/WR1//"Q5.0"/110,150,100/110,180,30/),
DEF VAR909=(B/*0=$85014,1=$85013//$85989,$85989,,/WR1//"Q5.2"/190,150,100/190,180,30/),


DEF work91=(I///,$85999,,/wr0,al2///0,320,510)
DEF VAR911=(B/*0=$85014,1=$85013//,,,/WR1//"M7.0"//30,350,30/),
DEF VAR912=(B/*0=$85014,1=$85013//,,,/WR1//"M7.2"//110,350,30/),
DEF VAR913=(B/*0=$85014,1=$85013//,,,/WR1//"M7.4"//190,350,30/),
DEF VAR914=(B/*0=$85014,1=$85013//,,,/WR1//"M7.5"//270,350,30/),
DEF VAR915=(B/*0=$85014,1=$85013//,,,/WR1//"M7.6"//350,350,30/),
DEF VAR916=(B/*0=$85014,1=$85013//,,,/WR1//"M7.7"//430,350,30/),
    HS1=($85991,ac7,se1);启动
	HS2=($85992,ac7,se1);停止
	HS3=($85993,ac7,se1);复位
	HS4=($85994,ac7,se1);取料
	HS5=($85995,ac7,se1);卡抓1松开
	HS6=($85996,ac7,se1);卡抓2松开
