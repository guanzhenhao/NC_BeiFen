...
//M(Mask1/$85020/"panel_1_1_eng.png"/)
	...
	DEF PITCH_COM=(R/-500,500//$85105,$85105,$85043,/WR2/"panel_1_11_eng.png"/"/NC/_N_NC_GD2_ACX/INI[25]"/360,210,202/460,210,60/);全长导程补偿
...
//M(Mask21/$85026/"blank.png"/)
	...
	DEF VAR17=(R/-2000,2000//$85536,$85536,,$85043/WR4/"panel_21_24.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[51]"/320,70,150/440,70,110/);外螺纹自动对刀测量头中心(左)到接近开关(右)的水平距离
...
//M(Mask5/$85381/"blank.png"/)
	DEF VAR1=(I/*0=$85058,1=$85059//$85063,$85063,,/WR2//"/NC/_N_NC_GD2_ACX/PARA_LOCK_SWITCH[2]"/0,0,0/530,20,18/);参数锁定开关
	DEF VAR2=(R/-500,500//$85609,$85608,,/WR2/"panel_5_1.png"/"$R[14]"/330,20,110/440,20,60/);砂轮修整轮中心水平重合
	DEF VAR3=(R/0,300//$85902,$85614,,$85043/WR2/"panel_5_7.png"/"$R[10]"/330,40,110/440,40,110/);双滚轮间距
	DEF VAR4=(R/-5,5//$85901,$85900,,$85043/WR2/"panel_5_11.png"/"$R[11]"/330,100,110/440,100,110/);左右轮高度差
	DEF VAR5=(R/-500,500//$85905,$85904,/WR2/"panel_5_10.png"/"$R[15]"/330,60,130/440,60,60/);修整轮圆弧中心和砂轮中心在V方向重合时的V坐标
	DEF VAR6=(R/-500,500//$85912,$85913,,/WR2/"panel_5_4.png"/"$R[7]"/330,130,130/440,130,60/);修整轮与砂轮当前接触位置
	DEF VAR7=(R/-500,500//$85908,$85906,,/WR2/"panel_5_8.png"/"$R[16]"/330,165,110/440,165,60/);修整结束水平轴停靠点
	DEF VAR8=(R/-500,500//$85909,$85907,,/WR2/"panel_5_9.png"/"$R[17]"/330,185,110/440,185,60/);修整结束垂直轴停靠点
	DEF VAR9=(R/0,10//$85611,$85611,,$85043/WR2/"panel_5_2.png"/"$R[29]"/330,80,110/440,80,110/);右圆弧半径
	DEF VAR10=(R/0,500//$85620,$85620,,$85043/WR2/"panel_5_5.png"/"/NC/_N_NC_GD2_ACX/WHEEL[1]"/330,240,110/440,240,110/);修整轮直径
	DEF VAR11=(R/0,60//$85621,$85621,,$85045/WR2/"panel_5_6.png"/"/NC/_N_NC_GD2_ACX/WHEEL[2]"/330,260,110/440,260,110/);修整轮线速度
	DEF VAR12=(I///$85600,$85600,,$85044/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[20]"/330,280,110/440,280,110/);修整轮转速
	DEF VAR13=(R/0,500//$85917,$85916,,$85043/WR2/"panel_5_12.png"/"$R[28]"/330,205,110/440,205,110/);修新砂轮时的左右偏移量
	DEF QCHECK=(I////WR4//"/Plc/Q113.5"/0,0,0/0,0,0);循环启动Q点检测
