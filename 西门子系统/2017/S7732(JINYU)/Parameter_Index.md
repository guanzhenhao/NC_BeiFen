...
|INI[122]||右齿面磨削插补的总角度
|INI[123]||
|INI[124]||=0X向磨削或当前磨削左齿面,=1当前磨削右齿面
|INI[125]||=0只磨左齿面,=1只磨右齿面,=2左右齿面都磨
|||
|**对刀(TOOL_SET)**||
...
|TOOL_SET[57]||=0左齿面对刀,=1右齿面对刀
|TOOL_SET[58]||=0单导程,=1双导程
|TOOL_SET[59]||计算出的右齿面C轴起始角度
...
|TECHNOLOGY[3]|GRIND_METHOD_F|精修单双磨削
|||
|TECHNOLOGY[310]|TECH_TIME_R|粗磨次数
|TECHNOLOGY[311]|TECH_TIME_MR|半粗磨次数
|TECHNOLOGY[312]|TECH_TIME_MF|半精磨次数
|TECHNOLOGY[313]|TECH_TIME_F|精磨次数
|||
|TECHNOLOGY[320]|TECH_GRIND_DEEP_R|粗磨进给量
|TECHNOLOGY[321]|TECH_GRIND_DEEP_MR|半粗磨进给量
|TECHNOLOGY[322]|TECH_GRIND_DEEP_MF|半精磨进给量
|TECHNOLOGY[323]|TECH_GRIND_DEEP_F|精磨进给量
|||
|TECHNOLOGY[330]|TECH_GRIND_FEED_R|粗磨速度
|TECHNOLOGY[331]|TECH_GRIND_FEED_MR|半粗磨速度
|TECHNOLOGY[332]|TECH_GRIND_FEED_MF|半精磨速度
|TECHNOLOGY[333]|TECH_GRIND_FEED_F|精磨速度
|||
|TECHNOLOGY[340]|TECH_DRESS_CUMU_R|粗磨是否修整累计
|TECHNOLOGY[341]|TECH_DRESS_CUMU_MR|半粗磨是否修整累计
|TECHNOLOGY[342]|TECH_DRESS_CUMU_MF|半精磨是否修整累计
|TECHNOLOGY[343]|TECH_DRESS_CUMU_F|精磨是否修整累计
|||
|TECHNOLOGY[350]|WHEEL_LINESPEED_GRIND_R|磨削砂轮线速度
|TECHNOLOGY[351]|WHEEL_LINESPEED_GRIND_MR|磨削砂轮线速度
|TECHNOLOGY[352]|WHEEL_LINESPEED_GRIND_MF|磨削砂轮线速度
|TECHNOLOGY[353]|WHEEL_LINESPEED_GRIND_F|磨削砂轮线速度
|||
